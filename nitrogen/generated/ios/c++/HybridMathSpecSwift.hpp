...
namespace margelo::nitro::bugzzapp {
  ...
  public:
    ...
    explicit HybridMathSpecSwift(const BugzzApp::HybridMathSpecCxx& swiftPart):
      HybridObject(HybridMathSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline BugzzApp::HybridMathSpecCxx getSwiftPart() noexcept { return _swiftPart; }
  ...
  private:
    BugzzApp::HybridMathSpecCxx _swiftPart;
  };
